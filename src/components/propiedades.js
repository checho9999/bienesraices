...
//String(id) recibido a traves del ruteo dinamico del slug enviado desde el Boton de propiedadPreview
...
const Propiedades = ( { data: { allStrapiPropiedades: { nodes } } } ) => {
    ...
    //Extraemos los datos de la propiedad determinado por su slug
